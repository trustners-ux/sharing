...
export const navExpensesPricingModule: LearningModule = {
  ...
  icon: 'Calculator',
  description:
    'Learn how NAV is calculated, understand Total Expense Ratio (TER), exit loads, cut-off timings, and pricing mechanisms. Key numerical concepts for the NISM VA exam.',
  level: 'intermediate',
  ...
  sections: [
    // ── Section 1: What is NAV? ─────────────────────────────────────────
    {
      ...
      content: {
        ...
        explanation:
          'Let me simplify NAV for you the way I explain it to every new sub-broker joining our network. Think of a mutual fund as a big community kitchen — 100 families pool money, buy groceries, and hire a cook. If the total value of groceries, utensils, and cash in the kitchen is ₹10 lakhs, and there are 100 equal shares, each family\'s share is ₹10,000. That is the NAV — the per-unit value of the pool. Now here is the single biggest misconception I see among clients and even new distributors: a fund with NAV of ₹15 is NOT cheaper or better than a fund with NAV of ₹500. NAV is simply a reflection of how long the fund has been running and how much it has grown. A new fund starts at ₹10 (the base NAV in India), and as the underlying securities appreciate, the NAV rises. A fund with ₹500 NAV simply means it has been around longer or has grown more — it says absolutely nothing about future returns. What matters is the percentage return, not the absolute NAV. If both funds deliver 12% returns, ₹1 lakh invested in either will become ₹1.12 lakhs in a year, regardless of whether you hold 200 units at ₹500 or 6,667 units at ₹15. The NISM exam loves testing this concept — expect at least one question on NAV misconceptions.',
        realLifeExample:
          'Rajesh, a 40-year-old businessman in Jaipur, wants to invest ₹5 lakhs. His friend tells him to buy "Fund A" because its NAV is only ₹18, while "Fund B" has a NAV of ₹450, so it is "too expensive." You, as his distributor, explain: if he invests ₹5 lakhs in Fund A at ₹18 NAV, he gets 27,778 units. If he invests the same ₹5 lakhs in Fund B at ₹450 NAV, he gets 1,111 units. After one year, both funds deliver 15% returns. Fund A NAV becomes ₹20.70, his investment becomes ₹5,75,000. Fund B NAV becomes ₹517.50, his investment also becomes ₹5,75,000. The absolute NAV made zero difference — the percentage return determined the final corpus. Rajesh is convinced, invests in Fund B (which had a better track record), and thanks you for clearing his misconception.',
        keyPoints: [
    ...
    // ── Section 2: Mark-to-Market & Fair Valuation ──────────────────────
    {
      ...
      content: {
        ...
        explanation:
          'Let me explain MTM with a real scenario. Suppose a mutual fund bought 10,000 shares of Infosys at ₹1,400 three months ago. Today, Infosys is trading at ₹1,650. Should the fund show the Infosys holding at the purchase price (₹1.40 crores) or current market price (₹1.65 crores)? The answer is clear — SEBI requires current market price. This is mark-to-market. Why does this matter? Because an investor redeeming today should get the fair value of the fund, not a historical cost that may be outdated. MTM ensures that NAV accurately reflects reality every single day. Now, equity is simple — you pick the closing price from NSE/BSE. But debt gets tricky. Government bonds, corporate bonds, and money market instruments don\'t trade actively on exchanges like stocks do. For these, AMFI and CRISIL publish daily valuation matrices that fund houses must use. If a corporate bond is downgraded from AAA to AA, its valuation drops immediately, and this impacts the fund\'s NAV the same day. This is where things like the IL&FS crisis (2018) and Franklin Templeton crisis (2020) hit investors hard — debt securities that were valued at par suddenly had to be marked down because the issuers could not repay. Side-pocketing was introduced by SEBI in 2018 precisely for such situations — but we will cover that in a later section.',
        realLifeExample:
    ...
    // ── Section 3: Total Expense Ratio (TER) ────────────────────────────
    {
      ...
      content: {
        definition:
          'Total Expense Ratio (TER) is the annual percentage of a mutual fund scheme\'s average daily net assets that is charged to the scheme to cover all operating expenses. TER includes fund management fees, registrar and transfer agent fees, custodian fees, audit fees, legal costs, selling and marketing expenses (including distributor commission in regular plans), and other operational costs. SEBI prescribes maximum TER slabs based on the fund\'s AUM — larger funds must have lower TER. The TER is deducted from the fund\'s assets daily (pro-rata) and is automatically reflected in the NAV, meaning investors do not pay TER separately.',
        explanation:
          'TER is the single most important cost metric for a mutual fund investor, and as a distributor, you need to understand it inside-out. Think of TER as the annual management charge — it is the price the investor pays for professional fund management. Here is the crucial point: TER is not charged separately to the investor. It is deducted from the fund\'s assets every day (1/365th of annual TER), and the NAV you see already reflects this deduction. So when a fund reports 12% annual return, that is after TER has been deducted. Now, the biggest TER-related concept you must master is the difference between Direct and Regular plans. SEBI mandated in January 2013 that every scheme must have two plans: Direct (where the investor approaches the AMC directly, no distributor involved) and Regular (where the investor comes through a distributor like you). The Regular plan TER is higher because it includes your trail commission. Typical difference: 0.50% to 1.00% per year. Over 20 years, this compounds significantly. A 1% annual TER difference on ₹10 lakhs growing at 12% means roughly ₹7-8 lakhs less in the Regular plan over 20 years. This is why you must add value beyond just selling — provide financial planning, goal tracking, behavioural coaching, and rebalancing advice to justify your commission.',
        realLifeExample:
          'Deepak, a 35-year-old IT professional in Bangalore, is comparing two options for investing ₹20,000/month in a large-cap fund:\n\nOption 1 — Direct Plan: TER = 0.55%, Expected return = 12% gross, Net return after TER ≈ 11.45%\nOption 2 — Regular Plan (through you as distributor): TER = 1.35%, Expected return = 12% gross, Net return after TER ≈ 10.65%\n\nOver 25 years (₹20,000/month SIP):\n• Direct Plan corpus: approximately ₹2.85 crores\n• Regular Plan corpus: approximately ₹2.48 crores\n• Difference: approximately ₹37 lakhs\n\nDeepak asks you: "Why should I invest through you when Direct plan gives me ₹37 lakhs more?" Your answer: "Because I will ensure you stay invested during market crashes (2008, 2020), rebalance your portfolio annually, track your 5 goals systematically, file your capital gains taxes correctly, and prevent you from panic selling. Investors without advisors typically earn 3-4% less than the fund\'s actual returns due to behavioural mistakes — that costs you far more than the TER difference."',
        keyPoints: [
          'TER = Total scheme expenses for the year / Average daily net assets of the scheme, expressed as a percentage',
          'TER components: fund management fees, registrar fees, custodian fees, audit fees, legal fees, selling/marketing expenses, investor communication costs, and GST on management fees',
          'SEBI TER slabs for equity-oriented schemes: First ₹500 crore AUM — max 2.25%; Next ₹250 crore — max 2.00%; Next ₹1,250 crore — max 1.75%; Next ₹3,000 crore — max 1.50%; Next ₹5,000 crore — max 1.25%; Next ₹40,000 crore — max TER reduces further; Above ₹50,000 crore — max 1.05%',
          'SEBI TER slabs for non-equity (debt) schemes: First ₹500 crore — max 2.00%; Next ₹250 crore — max 1.75%; Next ₹1,250 crore — max 1.50%; Next ₹3,000 crore — max 1.25%; Next ₹5,000 crore — max 1.00%; Above ₹50,000 crore — max 0.80%',
          ...
          'Index funds and ETFs have the lowest TER (often 0.05% to 0.20%) because they are passively managed',
        ],
        formula: 'TER = (Total Scheme Expenses in a Year / Average Daily Net Assets) x 100',
        numericalExample:
          'A large-cap equity fund has:\n• Average daily net assets (AUM): ₹8,000 crores\n• Fund management fees: ₹80 crores\n• Registrar & transfer agent fees: ₹8 crores\n• Custodian fees: ₹4 crores\n• Audit & legal fees: ₹2 crores\n• Selling & marketing expenses: ₹36 crores\n• Other expenses: ₹10 crores\n• Total expenses = ₹140 crores\n\nTER = (₹140 crores / ₹8,000 crores) x 100 = 1.75%\n\nDaily TER deduction = 1.75% / 365 = 0.00479% per day\nIf NAV is ₹100 today, the TER deduction is ₹0.00479, and the NAV published will be after this deduction.\n\nDirect Plan of the same fund may have TER of 1.05% (no distributor commission), meaning the difference of 0.70% is the trail commission paid to distributors annually.',
        faq: [
          {
            question: 'Does a higher TER mean the fund is poorly managed?',
            answer:
              'Not necessarily. TER reflects the cost structure, not the quality of management. Actively managed small-cap funds often have higher TER (due to more research required) but may still deliver excellent returns. What matters is the return after TER (net return to investor). However, if two funds have similar gross returns, the one with lower TER will deliver better net returns. Always compare TER within the same fund category.',
          },
          {
            question: 'Why do larger funds have lower TER caps under SEBI rules?',
            answer:
              'SEBI prescribes decreasing TER slabs based on AUM because of economies of scale. A fund managing ₹50,000 crores does not need 10x the operational cost of a ₹5,000 crore fund — many costs (audit, legal, technology) are relatively fixed. The decreasing slab structure ensures that large funds pass on the cost benefit to investors through lower TER.',
          },
          {
          ...
          {
            question: 'If TER is deducted from NAV, how do I know how much I am paying?',
            answer:
              'The TER is disclosed in the fund\'s monthly factsheet, on the AMC website, and on the AMFI website. SEBI mandates that AMCs must disclose daily TER on their website. You can also calculate your approximate annual cost: if your investment value is ₹10 lakhs and TER is 1.5%, you are paying approximately ₹15,000 per year in expenses, deducted daily from your NAV at about ₹41 per day.',
          },
          {
            question: 'Can the AMC charge more than the SEBI-prescribed TER limit?',
            answer:
              'No. SEBI TER limits are maximum caps that cannot be exceeded. If an AMC\'s actual expenses exceed the prescribed limit, the AMC must bear the excess cost from its own profits. In practice, most funds charge close to the maximum permitted TER. Any TER increase must be communicated to unitholders in advance.',
          },
        ],
        mcqs: [
          {
            question: 'SEBI\'s maximum TER for an equity-oriented scheme with AUM of ₹400 crores is:',
            options: ['2.00%', '2.25%', '1.75%', '1.50%'],
            correctAnswer: 1,
            explanation:
              'For equity-oriented schemes, the maximum TER for the first ₹500 crore of AUM is 2.25%. Since the fund\'s AUM is ₹400 crores (within the first slab), the maximum permissible TER is 2.25%.',
          },
          {
            question:
          ...
          },
          {
            ...
            correctAnswer: 2,
            explanation:
              'Index funds and ETFs have the lowest TER because they are passively managed — they simply replicate the index without active stock selection. A Nifty 50 index fund typically has TER of 0.10% to 0.20%, compared to 1.5% to 2.0% for actively managed funds. Lower TER is one of the key advantages of passive investing.',
          },
        ],
        summaryNotes: [
          'TER is the total annual cost of running a mutual fund scheme expressed as a percentage of average daily net assets — it is deducted daily from NAV, not charged separately to investors',
          'SEBI prescribes maximum TER slabs based on AUM: equity funds max 2.25% for first ₹500 crore, decreasing with scale; debt funds max 2.00% for first ₹500 crore with similar decreasing slabs',
          ...
          'Additional TER of up to 0.30% is permitted on B30 (Beyond Top 30) city inflows to incentivize mutual fund penetration in smaller cities',
          'For the NISM exam, remember the TER slab structure, the Direct vs Regular difference, and that TER is reflected in NAV daily — not billed separately',
        ],
    ...
    // ── Section 4: Entry Load (Abolished) & Exit Load ───────────────────
    {
      ...
      content: {
        ...
        explanation:
          'Let me give you the full history because NISM loves asking about entry load abolition. Before August 2009, when a client invested ₹1 lakh in a mutual fund with 2.25% entry load, only ₹97,750 was actually invested — ₹2,250 went as entry load (which was mostly used to pay distributor upfront commission). This meant the investor was already at a loss on day one. SEBI abolished this under then-Chairman C.B. Bhave, arguing that investors should not bear the cost of distribution. After abolition, 100% of the invested amount gets invested. Now, distributors earn through trail commission built into TER instead of upfront commission. Exit load, however, still exists and serves an important purpose — it discourages short-term trading in schemes designed for long-term investing. The most common exit load is 1% if equity fund units are redeemed within one year of purchase. This means if you invested ₹1 lakh and redeem within 12 months when the value is ₹1.10 lakhs, you pay 1% exit load on ₹1.10 lakhs = ₹1,100. Your redemption proceeds become ₹1,08,900. The key point for the exam: exit load goes back to the scheme, not to the AMC. This means the remaining investors in the fund actually benefit when someone pays exit load.',
        realLifeExample:
          'Anita, a 38-year-old doctor in Chennai, invested ₹3 lakhs in an equity mutual fund on March 15, 2024. The scheme has an exit load of 1% if redeemed within 1 year. On November 20, 2024 (8 months later), she needs ₹2 lakhs urgently for her clinic renovation. Her investment has grown to ₹3.30 lakhs.\n\nShe redeems ₹2 lakhs worth of units:\n• Exit load = 1% of ₹2,00,000 = ₹2,000\n• Net redemption amount = ₹2,00,000 - ₹2,000 = ₹1,98,000\n• The ₹2,000 exit load goes back to the fund (not to the AMC), slightly boosting NAV for remaining investors\n\nHad Anita waited until March 16, 2025 (after completing 1 year), there would be zero exit load. You, as her distributor, should have advised her to explore a loan against mutual funds or redeem from a liquid fund instead to avoid this ₹2,000 charge.',
        keyPoints: [
        ...
        faq: [
          ...
          {
            question: 'Can exit load percentages change after I invest?',
            answer:
              'Yes, the AMC can change exit load structure with prospective effect (for new investments). However, the exit load applicable at the time of your investment will apply to your redemption — changes cannot be applied retrospectively to existing investors. If the AMC increases exit load, it must give 3 days notice to investors through its website and newspaper advertisement.',
          },
        ],
        mcqs: [
          {
    ...
    // ── Section 5: How Fund Houses Calculate NAV Daily ──────────────────
    {
      ...
      content: {
        ...
        explanation:
          'The NAV calculation process is like closing the books of a company every single day. Let me walk you through what happens inside a fund house between 3:30 PM (market close) and 11:00 PM (NAV publication deadline). Step 1: Market Close & Price Capture. At 3:30 PM, the NSE and BSE close. The fund accounting team captures the closing prices of every equity stock held in the portfolio. For debt securities, they download the day\'s AMFI/CRISIL valuation matrices. Step 2: Corporate Action Adjustments. Any corporate actions — stock splits, bonus issues, dividends declared, rights issues — are adjusted. If a stock went ex-dividend today, the dividend income is accrued. Step 3: Income Accrual. Interest accrued on bonds and debentures (calculated daily based on coupon rates) is added. Dividend income from stocks that went ex-dividend is recorded. Step 4: Expense Accrual. The day\'s share of TER is calculated (annual TER / 365) and deducted. Any other payables — management fees, custodian charges, registrar fees — are accrued. Step 5: Unit Capital Update. New subscriptions received today (that qualify for today\'s NAV based on cut-off timing) create new units. Redemptions processed today cancel units. The total outstanding units are updated. Step 6: NAV Computation. Net Assets (Total Assets - Total Liabilities) divided by Updated Outstanding Units = Today\'s NAV. Step 7: Publication. The NAV is published on the AMC website and AMFI website by 11:00 PM.',
        realLifeExample:
    ...
    // ── Section 6: Cut-off Timing ───────────────────────────────────────
    {
      ...
      content: {
        ...
        explanation:
          'Cut-off timing is one of the most practical and frequently tested concepts in the NISM exam, and in my experience, it is also the most misunderstood concept among new distributors and clients. Let me make it crystal clear. The fundamental rule is: you get the NAV of the day your valid application AND funds reach the AMC/RTA before the cut-off time. Both conditions must be met — application alone is not enough, and funds alone are not enough. For equity, hybrid, and most debt fund purchases: if your application with funds reaches the AMC before 3:00 PM, you get that day\'s closing NAV. If it reaches after 3:00 PM, you get the next business day\'s closing NAV. For redemptions: the same 3:00 PM rule applies. Redeem before 3:00 PM, you get that day\'s NAV. After 3:00 PM, next day\'s NAV. Now here is where it gets interesting with liquid and overnight funds. Since these are meant for very short-term parking of money, even one day\'s NAV difference matters. So SEBI has tighter cut-offs: purchase before 1:30 PM gets same-day NAV; purchase between 1:30 PM and 3:00 PM gets next-day NAV. For redemption of liquid funds, the cut-off is 3:00 PM (same as equity). Switch transactions add another layer of complexity. When you switch from Fund A to Fund B, it is treated as a redemption from Fund A and a purchase into Fund B. The redemption NAV of Fund A and the purchase NAV of Fund B may be of different days depending on the cut-off timings and fund categories.',
        realLifeExample:
          'Let us trace three real scenarios from my distribution practice:\n\nScenario 1 — Prashant submits an online SIP in an equity fund at 2:45 PM on Monday. His bank auto-debit clears by 2:50 PM. Since both application and funds are received before 3:00 PM, Prashant gets Monday\'s closing NAV (published that evening around 10 PM). If Monday\'s NAV is ₹45.20, his ₹10,000 SIP buys 221.24 units.\n\nScenario 2 — Sunita submits a lump sum purchase of ₹5 lakhs in the same equity fund at 3:15 PM on Monday via her bank\'s net banking. Even though the transaction was initiated on Monday, since it was after 3:00 PM, she gets Tuesday\'s closing NAV. If Tuesday\'s NAV jumps to ₹46.10 (because markets rallied on Tuesday), Sunita gets fewer units: 10,845.99 units. Had she transacted 30 minutes earlier, she would have gotten 11,061.95 units — a difference of 216 units, worth ₹9,957.\n\nScenario 3 — Manoj wants to invest ₹50 lakhs in a liquid fund on Wednesday. He submits the application at 1:15 PM and his RTGS transfer reaches the AMC by 1:25 PM. Since both application and funds were received before 1:30 PM, he gets Wednesday\'s NAV. Had his RTGS been delayed to 1:35 PM, he would have gotten Thursday\'s NAV, potentially losing one day\'s return of approximately ₹600-700 on ₹50 lakhs.',
        keyPoints: [
        ...
        faq: [
          {
            question: 'If I submit an SIP auto-debit at 10 AM but the bank debits at 4 PM, which NAV do I get?',
            answer:
              'The applicable NAV depends on when the funds are actually credited to the AMC\'s account, not when the auto-debit instruction was submitted. If the bank processes the debit and the AMC receives funds before 3:00 PM, you get same-day NAV. If the funds reach the AMC after 3:00 PM (even though you initiated the transaction at 10 AM), you get the next business day\'s NAV. This is why NACH/ECS auto-debits for SIPs are typically processed early in the morning by banks.',
          },
          {
          ...
          {
            question: 'What if the market is highly volatile — can I time my transaction around 3 PM to get a better NAV?',
            answer:
              'Unlike stocks, you cannot see the mutual fund NAV before transacting because NAV is calculated AFTER market close (published by 11 PM). When you submit a purchase at 2:55 PM, you know you will get today\'s NAV, but you do not know what today\'s NAV will be — it will be calculated only after 3:30 PM market close. So there is no way to time NAV precisely. You can, however, observe market trends during the day and make a general judgment about whether markets are up or down.',
          },
          {
        ...
        summaryNotes: [
          'Cut-off timing determines which day\'s NAV applies to your transaction — both valid application AND funds must reach the AMC before the cut-off time',
          ...
          'You cannot see the NAV before transacting because it is calculated after market close (3:30 PM) and published by 11:00 PM — you can only choose to get today\'s or tomorrow\'s NAV based on when you submit',
    ...
    // ── Section 7: NAV, TER and Pricing in Segregated Portfolios ────────
    {
      ...
      content: {
        ...
        faq: [
          ...
          {
            question: 'Can I sell my segregated portfolio units if I need liquidity?',
            answer:
