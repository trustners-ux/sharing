...
export const investmentLandscapeModule: LearningModule = {
  ...
  sections: [
    // ── Section 1: Why People Invest ─────────────────────────────────
    {
      ...
      content: {
        definition: 'Investing is the act of deploying money into assets or instruments with the expectation of generating returns over time to meet specific financial goals. Unlike saving, which merely preserves capital, investing puts your money to work so it grows faster than inflation. People invest because their future financial needs — children\'s education, a home, retirement — require amounts far beyond what monthly savings alone can accumulate. The fundamental reason anyone invests is the gap between what they earn today and what they will need tomorrow.',
        explanation: 'In my 25 years in the industry, I\'ve seen thousands of clients walk in with the same question: "Why should I invest? My salary is decent." Here\'s what your client really needs to understand — there is a crucial difference between needs, wants, and goals. Needs are non-negotiable expenses like food, housing, and healthcare. Wants are lifestyle upgrades like a bigger car or a vacation. Goals are specific future financial targets like your child\'s engineering seat at ₹25 lakhs in 15 years, or a retirement corpus of ₹3 crores in 25 years. Saving alone cannot bridge this gap because of one silent enemy: inflation. If inflation runs at 6% per year, the cost of things doubles roughly every 12 years. So that ₹25 lakh engineering seat will cost ₹50 lakhs in 12 years. Your client must invest — not just save — to stay ahead of this curve. Financial goals are broadly classified into three buckets: short-term (1-3 years) like an emergency fund or vacation; medium-term (3-7 years) like a car purchase or child\'s school admission donation; and long-term (7+ years) like retirement, child\'s higher education, or building a house. Each goal demands a different investment strategy, and this is where you, as a distributor, add tremendous value.',
        realLifeExample: 'Meet Suresh, a 32-year-old bank manager in Pune earning ₹75,000/month. He has three goals: (1) Build an emergency fund of ₹4.5 lakhs (6 months expenses) in 1 year — short-term, so he uses a liquid fund SIP of ₹37,500/month. (2) Save ₹12 lakhs for his daughter Ananya\'s school admission in 5 years — medium-term, so he starts a ₹15,000/month SIP in a balanced advantage fund. (3) Build a retirement corpus of ₹3 crores in 28 years — long-term, so he starts a ₹10,000/month SIP in a flexi-cap equity fund. Without investing, Suresh would have only ₹33.6 lakhs in 28 years from savings. With a 12% equity return, his ₹10,000/month SIP alone can grow to over ₹1.5 crores. That is the power of goal-based investing.',
        keyPoints: [
          ...
          'As a distributor, your first job is to help the client articulate and prioritize their goals',
          'The earlier you start investing, the less you need to invest each month — time is the greatest asset',
        ],
        faq: [
          {
            question: 'Why can\'t I just save in a bank account for my goals?',
            answer: 'Bank savings accounts typically offer 3-4% interest, while inflation in India averages 6-7%. This means your money is actually losing purchasing power every year in a savings account. Investing in mutual funds has historically delivered 10-15% returns in equity over long periods, helping you stay ahead of inflation and build real wealth.',
          },
          {
    ...
    // ── Section 2: Savings vs Investment ──────────────────────────────
    {
      ...
      content: {
        ...
        explanation: 'Here\'s what I tell every new sub-broker on day one: your client already knows how to save — they\'ve been doing it since their first piggy bank. Your job is to show them why saving alone is not enough. A bank FD giving 7% sounds safe, but after 30% tax (for someone in the highest bracket), the post-tax return is just 4.9%. If inflation is 6%, the real return is actually negative — they are losing purchasing power every single year while feeling "safe." This is the savings trap. Investing, by contrast, means accepting short-term volatility for long-term wealth creation. An equity mutual fund that gives 12% per annum will double money in 6 years (Rule of 72), quadruple it in 12 years, and grow it 8x in 18 years. The NISM exam will test you on this difference — understand it deeply. The risk-return tradeoff is the foundation of all financial planning: low risk gives low returns (savings), moderate risk gives moderate returns (balanced funds), and higher risk gives higher potential returns (equity). Your job as a distributor is to match the client\'s risk tolerance with the right product.',
        realLifeExample: 'Consider two friends, Meera and Kavita, both 25 years old, both investing ₹10,000 per month for 30 years until retirement at 55:\n\nMeera (the Saver): Puts ₹10,000/month in bank FD at 7% interest. After 30% tax, effective rate is 4.9%. After 30 years, her corpus is approximately ₹78 lakhs. Adjusted for 6% inflation, the real value is only about ₹13.5 lakhs in today\'s money.\n\nKavita (the Investor): Puts ₹10,000/month in a diversified equity mutual fund SIP averaging 12% returns. After 30 years, her corpus is approximately ₹3.53 crores. Even after LTCG tax and inflation adjustment, the real value is roughly ₹52 lakhs in today\'s money.\n\nSame monthly amount. Same discipline. But Kavita ends up with nearly 4x Meera\'s wealth in real terms, simply because she chose to invest rather than just save.',
        keyPoints: [
        ...
        faq: [
          ...
          },
          {
            ...
            answer: 'Many people prefer FDs because of familiarity, perceived safety, and guaranteed returns. They don\'t see the impact of inflation and taxes on their real wealth. As a distributor, your role is to educate clients about real returns while respecting their risk comfort. Start by suggesting a small equity allocation alongside their FDs.',
          },
          {
          ...
          },
          {
            ...
            answer: 'FD interest is taxed at your income tax slab rate (up to 30% + surcharge). Equity fund LTCG (gains above ₹1.25 lakh on holdings over 1 year) is taxed at just 12.5%. Debt fund gains are taxed at the applicable slab rate. This tax efficiency makes equity mutual funds significantly more attractive for long-term wealth creation compared to FDs.',
          },
        ],
        mcqs: [
          {
        ...
        summaryNotes: [
          ...
          'FD at 7% in the 30% tax bracket yields only 4.9% post-tax, which is below 6% inflation — a net loss in real terms',
    ...
    // ── Section 3: Asset Classes Explained ────────────────────────────
    {
      ...
      content: {
        ...
        explanation: 'Think of asset classes as different vehicles — a bicycle, a car, a bus, and a train. Each gets you to your destination, but at different speeds, comfort levels, and costs. In my 25 years in the industry, I\'ve seen clients put all their money in one asset class and suffer. The 2008 crash wiped out equity-only portfolios. The real estate slowdown of 2015-2020 trapped clients who had 80% in property. But diversified portfolios recovered and thrived. Here\'s what your client really needs to understand about each asset class in India: Equity offers the highest long-term growth (12-15% CAGR) but comes with short-term volatility — ideal for goals 7+ years away. Debt provides stable, predictable returns (6-8%) with lower risk — perfect for short to medium-term goals. Gold is a hedge against inflation and currency depreciation — historically 8-10% returns in INR terms and acts as insurance during crises. Real estate provides rental income and capital appreciation but has low liquidity, high entry cost, and significant transaction charges. The NISM exam will test you extensively on asset class characteristics, so know them well.',
        realLifeExample: 'Prakash, a 40-year-old businessman in Jaipur, had his entire ₹1.5 crore net worth split as: ₹80 lakhs in a commercial property (53%), ₹40 lakhs in FDs (27%), ₹20 lakhs in gold jewelry (13%), and ₹10 lakhs in a savings account (7%). Zero equity exposure. When COVID hit in 2020, his rental income stopped, he couldn\'t sell the property quickly, FD rates dropped to 5%, and he needed cash. After working with a distributor, he restructured: sold some gold jewelry and bought Sovereign Gold Bonds instead (earning 2.5% interest on gold). Moved ₹15 lakhs from FDs to equity mutual fund SIPs for long-term goals. Kept ₹10 lakhs in liquid funds as emergency reserves. Within 3 years, his equity portfolio grew by 45%, his gold bonds appreciated, and he had liquid reserves for any future emergency.',
        keyPoints: [
    ...
    // ── Section 4: Understanding Investment Risk ──────────────────────
    {
      ...
      content: {
        ...
        explanation: 'The NISM exam will test you heavily on this topic, so pay close attention. In my 25 years in the industry, I\'ve seen two extremes: clients who are so afraid of risk they keep everything in FDs and lose to inflation, and clients who chase high returns without understanding the risks and panic-sell during market corrections. Both approaches destroy wealth. Let me break down each type of risk clearly. Market Risk (Systematic Risk) affects the entire market — events like COVID-19, the 2008 financial crisis, or RBI rate hikes impact all stocks. You cannot diversify away market risk within a single asset class. Credit Risk is the risk that a bond issuer defaults — remember the IL&FS crisis of 2018 when even highly-rated bonds defaulted? Interest Rate Risk affects bond prices — when RBI raises rates, existing bond prices fall (and vice versa). Inflation Risk is the silent killer we discussed — your 7% FD earning a real return of barely 1% after tax. Liquidity Risk means you cannot sell an investment quickly without a significant price discount — real estate is the classic example. Concentration Risk is having too much money in one stock, one sector, or one asset class. Now here\'s the critical concept: risks are broadly classified into Systematic Risk (market-wide, cannot be diversified away) and Unsystematic Risk (company or sector-specific, CAN be reduced through diversification). A well-diversified mutual fund portfolio addresses unsystematic risk, while asset allocation across equity, debt, and gold manages systematic risk.',
        realLifeExample: 'In September 2018, the IL&FS group defaulted on its debt obligations. Several debt mutual funds that held IL&FS bonds saw their NAVs fall by 5-15% overnight. One of my clients, a retired colonel, had invested ₹40 lakhs entirely in a single credit-risk debt fund. When the IL&FS news broke, his fund\'s NAV dropped 12%, wiping out ₹4.8 lakhs of his retirement corpus in a week. He was devastated. The lesson? He had taken on credit risk (by choosing a fund with lower-rated bonds for higher yield) AND concentration risk (by putting all his money in one fund). After restructuring, we spread his ₹35 lakhs across 3 categories: ₹15 lakhs in a banking & PSU debt fund (high credit quality), ₹10 lakhs in an overnight fund (zero credit risk), and ₹10 lakhs in a balanced advantage fund (for growth). His portfolio was now diversified across credit risk levels and asset classes.',
        keyPoints: [
      ...
      content: {
        ...
        faq: [
          ...
          },
          {
            ...
            answer: 'This is a common challenge. As a distributor, you must explain the mismatch between their desire (greed) and their capacity (reality). Document the risk profile assessment and your recommendation. If the client insists, you can allocate a small "satellite" portion (10-15%) to aggressive funds while keeping the core portfolio aligned with their actual risk capacity. Always get written acknowledgment.',
          },
          {
    ...
    // ── Section 6: Power of Compounding ───────────────────────────────
    {
      ...
      content: {
        ...
        explanation: 'In my 25 years in the industry, I\'ve seen compounding transform ordinary middle-class families into crorepatis. But here\'s the catch — compounding is a slow magic. In the first few years, it looks unimpressive. The real explosion happens in the later years. Let me illustrate: if you invest ₹10,000/month at 12% per annum, after 10 years you\'ll have about ₹23 lakhs on an investment of ₹12 lakhs — a gain of ₹11 lakhs. After 20 years, you\'ll have about ₹1 crore on ₹24 lakhs invested — a gain of ₹76 lakhs. And after 30 years, you\'ll have about ₹3.53 crores on just ₹36 lakhs invested — a gain of ₹3.17 crores. Notice the pattern: in the first 10 years, your money doubled. In the next 10, it grew 4x. In the final 10 years, it grew 3.5x more! The gain in the last 10 years (₹2.53 crores) was more than the total corpus of the first 20 years. This is the snowball effect of compounding. The NISM exam will test you on compound interest calculations, so master the formula. As a distributor, your most powerful tool is showing clients this exponential growth chart — it converts fence-sitters into committed SIP investors.',
        realLifeExample: 'Meet two colleagues: Deepak (the Early Starter) and Ravi (the Late Starter). Both want to retire at 60 with a target corpus.\n\nDeepak starts a SIP of ₹10,000/month at age 25. He invests for 35 years at an assumed 12% annual return.\nTotal invested: ₹10,000 x 12 x 35 = ₹42 lakhs\nCorpus at 60: approximately ₹6.49 crores\nWealth gained from compounding: ₹6.07 crores\n\nRavi starts the same ₹10,000/month SIP at age 35. He invests for 25 years at the same 12% return.\nTotal invested: ₹10,000 x 12 x 25 = ₹30 lakhs\nCorpus at 60: approximately ₹1.90 crores\nWealth gained from compounding: ₹1.60 crores\n\nDeepak invested only ₹12 lakhs more than Ravi, but his corpus is ₹4.59 crores MORE. Those extra 10 years of compounding — not the extra ₹12 lakhs — created the massive difference. When I show this chart to a 25-year-old client, they start their SIP that very day.',
        keyPoints: [
          'Compounding means earning returns on both your principal AND on previously earned returns — it creates exponential, not linear, growth',
    ...
    // ── Section 7: Inflation — The Silent Wealth Destroyer ────────────
    {
      ...
      content: {
        ...
        explanation: 'The NISM exam will test you on inflation\'s impact on investments, so understand this deeply. In my 25 years in the industry, I\'ve seen inflation destroy more wealth than market crashes ever did — because market crashes are visible and temporary, while inflation is invisible and permanent. Here\'s what your client really needs to understand: the ₹50 lakhs they think is enough for retirement will actually buy only ₹14 lakhs worth of goods in 20 years at 6% inflation. The real villain is not market volatility — it is the combination of inflation and taxes on "safe" investments. Consider this: a senior citizen puts ₹50 lakhs in an FD at 7.5%. He earns ₹3.75 lakhs per year. But in the 30% tax bracket, he keeps only ₹2.625 lakhs after tax, which is an effective 5.25% return. If inflation is 6%, his REAL return is negative 0.75%. He is literally getting poorer each year while his bank passbook shows a growing balance. This is the cruel irony of "safe" investing. India has multiple types of inflation that affect different client segments differently: Food inflation hits lower-income clients hardest. Education inflation (10-12% per year) devastates parents saving for children\'s education. Healthcare inflation (12-15%) is the biggest threat to retirees. Your job as a distributor is to help clients invest in instruments that beat their specific inflation rate.',
        realLifeExample: 'Rajesh\'s father, Mr. Sharma, retired in 2004 with ₹20 lakhs — a substantial sum at the time. He put everything in FDs because "the stock market is gambling." In 2004, his monthly expenses were ₹15,000. His FD interest of ₹14,000/month (at 7% on ₹20L) almost covered his expenses. Fast forward to 2024 — twenty years later. His monthly expenses have risen to ₹48,000 (at 6% annual inflation, expenses roughly tripled). His FD balance, after periodic withdrawals for living expenses and medical emergencies, has shrunk to ₹6 lakhs. The interest on ₹6 lakhs at 6.5% gives him just ₹3,250/month. He is now financially dependent on his son Rajesh. Had Mr. Sharma invested even 40% of his ₹20 lakhs in equity mutual funds (₹8 lakhs) in 2004 at 14% CAGR, that portion alone would have been worth approximately ₹1.07 crores in 2024 — enough to sustain him comfortably. The remaining ₹12 lakhs in debt funds would have provided stability. This is the real-life cost of ignoring inflation.',
        keyPoints: [
          ...
          'Equity is the only asset class that has consistently beaten inflation over long periods in India (12-15% CAGR vs 6-7% inflation)',
          'A distributor must frame every financial conversation in real (inflation-adjusted) terms, not nominal terms',
          'Lifestyle inflation (increasing expenses as income grows) is a behavioral risk that compounds the problem — help clients control it',
        ],
        ...
        numericalExample: 'What will ₹100 be worth in 20 years at 6% inflation?\n\nPurchasing Power = ₹100 / (1.06)^20\nPurchasing Power = ₹100 / 3.2071\nPurchasing Power = ₹31.18\n\nToday\'s ₹100 will buy only ₹31.18 worth of goods in 20 years!\n\n--- Real Return Comparison ---\n\nFD at 7%, Tax bracket 30%, Inflation 6%:\nPost-tax return = 7% x (1 - 0.30) = 4.9%\nReal return = ((1.049) / (1.06)) - 1 = -1.04%\nResult: NEGATIVE real return. Wealth is being destroyed.\n\nEquity Fund at 12%, LTCG tax ~12.5% (effective ~2%), Inflation 6%:\nEffective post-tax return = approx 10%\nReal return = ((1.10) / (1.06)) - 1 = +3.77%\nResult: POSITIVE real return. Wealth is being created.\n\n--- Education Cost Projection ---\nEngineering degree today: ₹10 lakhs\nEducation inflation: 10% per annum\nCost in 15 years: ₹10,00,000 x (1.10)^15 = ₹41,77,248\n\nYour client needs ₹42 lakhs for a goal that costs ₹10 lakhs today!',
        faq: [
          {
            question: 'What is the current inflation rate in India?',
            answer: 'India\'s CPI inflation has averaged around 5-6% over the last decade. The RBI targets 4% CPI inflation with a tolerance band of +/- 2% (i.e., 2% to 6%). However, specific categories like education (10-12%), healthcare (12-15%), and housing vary significantly. When planning for specific goals, use the relevant category inflation rate, not the headline CPI figure.',
          },
          {
            question: 'Why do FDs give negative real returns in higher tax brackets?',
            answer: 'An FD at 7% yields only 4.9% after 30% tax. If inflation is 6%, the real return is approximately -1.04%. The investor sees a growing bank balance but can actually buy less with that money each year. This is the "money illusion" — feeling richer while becoming poorer. It is worst for senior citizens in the 30% tax bracket who rely entirely on FD income.',
          },
          {
        ...
        mcqs: [
          ...
          {
            question: 'A Fixed Deposit offers 7.5% interest. For an investor in the 30% tax bracket with inflation at 6%, the real post-tax return is approximately:',
            options: [
              '+1.5%',
              '+0.75%',
              '-0.75%',
            ...
            correctAnswer: 2,
            explanation: 'Post-tax return = 7.5% x (1 - 0.30) = 5.25%. Real return = ((1.0525) / (1.06)) - 1 = -0.71%, approximately -0.75%. The investor is actually losing purchasing power despite earning "interest." This calculation is critical for client education and NISM exam preparation.',
          },
          {
        ...
        summaryNotes: [
          'Inflation is the sustained rise in prices that erodes purchasing power — at 6%, costs double every 12 years and today\'s ₹100 becomes worth just ₹31 in 20 years',
          'FDs in higher tax brackets often deliver NEGATIVE real returns — the investor feels safe but is actually losing wealth annually',
          'Education inflation (10-12%) and healthcare inflation (12-15%) are far higher than general CPI (5-6%) — use category-specific rates for goal planning',
