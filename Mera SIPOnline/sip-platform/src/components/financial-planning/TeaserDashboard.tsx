    ...
    <div className={`max-w-3xl mx-auto transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <div className="bg-gradient-to-r from-brand-700 to-brand-800 rounded-xl p-6 text-white mb-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-base font-bold mb-1">Your Detailed Report is Being Prepared</h3>
            <p className="text-sm text-teal-100 mb-3">
              Our team is preparing your comprehensive 10-page Financial Health Report with personalized
              recommendations. It will be sent to <strong className="text-white">{userEmail}</strong> within 24 hours.
            </p>
